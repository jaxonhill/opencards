...
import { HeatmapCellData, DAY_GRADE } from "../types/types";
 ...
 */
export function generateHeatmapData(): HeatmapCellData[] {
    const start = toLocalDate("2024-08-18");
    const end = toLocalDate("2025-08-22");
