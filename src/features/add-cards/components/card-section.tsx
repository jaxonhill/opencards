...
function HeaderIconButton({ children }: HeaderIconButtonProps) {
    return (
        <button className="inline-flex justify-center items-center px-2 py-2 transition-colors rounded-full text-neutral-300 [&>svg]:size-5 [&>svg]:shrink-0 hover:bg-neutral-900 hover:text-neutral-100 hover:cursor-pointer">
            {children}
        </button>
    );
}
